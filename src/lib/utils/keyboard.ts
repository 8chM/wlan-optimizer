...
export const SHORTCUTS: KeyboardShortcut[] = [
  ...
  { key: 'c', ctrl: true, action: 'copy', description_key: 'shortcuts.copy' },
  { key: 'x', ctrl: true, action: 'cut', description_key: 'shortcuts.cut' },
  { key: 'v', ctrl: true, action: 'paste', description_key: 'shortcuts.paste' },
  { key: 'd', ctrl: true, action: 'duplicate', description_key: 'shortcuts.duplicate' },
  { key: 'a', ctrl: true, action: 'selectAll', description_key: 'shortcuts.selectAll' },
  ...
  { key: 'd', action: 'doorTool', description_key: 'shortcuts.doorTool' },
  { key: 'f', action: 'windowTool', description_key: 'shortcuts.windowTool' },
